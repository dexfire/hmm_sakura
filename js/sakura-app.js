  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', '<%= theme.cdn %>/images/other/gravatar.jpg')
      } else {
        ele.src = '<%= theme.cdn %>/images/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = '<%= theme.cdn %>/images/other/default_gavatar.jpg'
      break
    case 3:
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == '<%= theme.cdn %>/images/themebg/sakura.png' || bgurl == '<%= theme.cdn %>/images/themebg/plaid.jpg' || bgurl == '<%= theme.cdn %>/images/themebg/star.png' || bgurl == '<%= theme.cdn %>/images/themebg/point.png' || bgurl == '<%= theme.cdn %>/images/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#KAdots-bg', '<%= theme.cdn %>/images/themebg/point.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(<%= theme.cdn %>/images/other/starry_sky.png)')
